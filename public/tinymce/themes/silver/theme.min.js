        ...
        (e) => {
          ...
          return (
            ...
            i.isStopped()
              ...
              : st(e.element).fold(
                  () => (r.logNoParent(t, e.element, o.purpose), Yw.complete()),
                  (n) => (
                    r.logEventResponse(t, e.element, o.purpose), Yw.resume(n)
                  )
                )
          )
        }
      ...
      var Ee = function (e) {
        ...
        Ie = function (e) {
          ...
          if (
            ...
            return Ee(e), !0
          if ('select' === s && bN(/<template/i, e.innerHTML)) return Ee(e), !0
          if (!L[s] || G[s]) {
            if (!G[s] && Ne(s)) {
